...
class Settings {
	...
	private static let KEY_WOTD = "wotd"
	...
	private static let DEFAULT_WOTD = false
	...
	class func getWotdEnabled() -> Bool {
		return getBoolPref(key: KEY_WOTD, defaultValue: DEFAULT_WOTD)
	}
	
	class func setWotdEnabled(enabled: Bool) {
		setPref(key: KEY_WOTD, value: enabled)
	}
